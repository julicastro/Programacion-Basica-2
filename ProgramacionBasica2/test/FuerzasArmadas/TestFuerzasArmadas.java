...
import FuerzasArmadas.Anfibio;
import FuerzasArmadas.Avion;
import FuerzasArmadas.Camion;
import FuerzasArmadas.Destructor;
import FuerzasArmadas.FuerzaArmada;
import FuerzasArmadas.HidroAvion;
import FuerzasArmadas.Portaviones;
import FuerzasArmadas.Submarino;
import FuerzasArmadas.Tanque;
import FuerzasArmadas.TipoDeBatalla;
...
public class TestFuerzasArmadas {
	...
	@Test
	public void queExistaBatalla() {
		FuerzaArmada argentina = new FuerzaArmada();
		double cord1 = 100.5;
		double cord2 = 20.3;
		String nombre = "San Lorenzo";
		Batalla batalla = new Batalla("San Lorenzo",cord1, cord2, TipoDeBatalla.TERRESTRE);
		argentina.crearBatalla(batalla);
		assertEquals(cord1, argentina.getBatalla("San Lorenzo").getLatitud(), 0.01);
		assertEquals(cord2, argentina.getBatalla("San Lorenzo").getLongitud(), 0.01);
		assertNotNull(argentina.getBatalla("San Lorenzo"));
